...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "users" (
  	...
  	"auth_provider" "enum_users_auth_provider" DEFAULT 'credentials',
  	"google_sub" varchar,
  	"avatar_url" varchar,
  ...
  ALTER TABLE "audit_reports" ADD CONSTRAINT "audit_reports_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "audit_reports_user_idx" ON "audit_reports" USING btree ("user_id");
  CREATE INDEX "audit_reports_property_id_idx" ON "audit_reports" USING btree ("property_id");
