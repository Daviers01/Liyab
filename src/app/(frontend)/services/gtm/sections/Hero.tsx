  ...
  return (
    <div className="max-w-4xl mx-auto text-center space-y-6">
      ...
      <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
        Comprehensive GTM services to elevate your business's online performance. From expert setup and custom tracking to thorough audits and consulting, I optimize your data collection to deliver actionable insights that power your digital strategy.
      </p>
