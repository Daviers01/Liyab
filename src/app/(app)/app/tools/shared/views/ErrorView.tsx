...
const ACCESS_NOTE = {
  ga4: 'Make sure you have at least Viewer access to a GA4 property',
  gtm: 'Make sure you have at least Read access to the GTM container',
} as const

export function ErrorView({ service, error, onReset }: ErrorViewProps) {
  return (
    <div className="px-6 md:px-8 py-16 max-w-lg mx-auto text-center space-y-5">
      ...
      <div className="rounded-xl border border-border bg-card/80 p-4 text-left space-y-2">
        ...
        <ul className="text-xs text-muted-foreground space-y-1 list-disc pl-4">
          <li>{ACCESS_NOTE[service]}</li>
          <li>Try connecting with a different Google account</li>
          <li>Check that pop-ups are not blocked for this site</li>
