...
const SERVICE_CONFIG = {
  ga4: {
    headline: 'Auditing Your GA4 Setup',
    steps: [
    ...
    timing: 'This usually takes 15\u201330 seconds depending on property size.',
  },
  gtm: {
    headline: 'Auditing Your GTM Setup',
    steps: [
      'Connecting to GTM API',
      'Reading live container version',
      'Analyzing tags, triggers & variables',
      'Checking consent mode & security',
      'Generating report',
    ],
    timing: 'This usually takes 10\u201320 seconds depending on container size.',
  },
} as const

export function AuditingView({ service, name, auditPhase }: AuditingViewProps) {
  const { headline, steps, timing } = SERVICE_CONFIG[service]
  ...
  return (
    <div className="px-6 md:px-8 py-16 max-w-md mx-auto space-y-8">
      ...
      <p className="text-center text-[11px] text-muted-foreground">{timing}</p>
    </div>
  )
}
