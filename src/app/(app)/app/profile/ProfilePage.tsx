...
export default function ProfilePage() {
  ...
  const [dangerMsg, setDangerMsg] = useState<{ type: 'success' | 'error'; text: string } | null>(
    null,
  )
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-6 md:px-8 py-6 max-w-3xl mx-auto space-y-6">
            ...
            <div className="rounded-2xl border border-border bg-card/80 overflow-hidden">
              <div className="p-5 md:p-6 border-b border-border space-y-1.5">
            ...
            <div className="rounded-2xl border border-border bg-card/80 overflow-hidden">
              ...
              <div className="p-5 md:p-6 space-y-4">
                {[...Array(2)].map((_, i) => (
                  <div key={i}>
                    <div className="h-3 w-24 bg-muted/60 rounded mb-1.5" />
                    <div className="h-9 w-full bg-muted/40 rounded-lg" />
                  </div>
                ))}
                <div className="flex justify-end pt-1">
        ...
        <div className="px-6 md:px-8 py-6 max-w-3xl mx-auto space-y-6">
          ...
          <div className="rounded-2xl border border-border bg-card/80 backdrop-blur-sm overflow-hidden">
            ...
            <div className="p-5 md:p-6 space-y-4">
              ...
              {profileMsg && (
                <p
                  className={`text-xs ${profileMsg.type === 'success' ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}
                >
                  {profileMsg.text}
                </p>
              )}
          ...
          <div className="rounded-2xl border border-border bg-card/80 backdrop-blur-sm overflow-hidden">
            ...
            <div className="p-5 md:p-6 space-y-4">
              {isGoogleOnly && (
                <div className="rounded-xl border border-blue-500/15 bg-blue-500/5 p-3 flex items-start gap-2.5">
                  ...
                  <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                    Google sign-up detected. Setting a password will allow you to log in with your
                    email and password in addition to Google.
                  </p>
                </div>
              )}
              ...
              {passwordMsg && (
                <p
                  className={`text-xs ${passwordMsg.type === 'success' ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}
                >
                  {passwordMsg.text}
                </p>
              )}
          ...
          <div className="rounded-2xl border border-red-500/20 bg-red-500/[0.02] overflow-hidden">
            ...
            <div className="p-5 md:p-6 space-y-5">
              ...
              {dangerMsg && (
                <p
                  className={`text-xs ${dangerMsg.type === 'success' ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}
                >
                  {dangerMsg.text}
                </p>
              )}
